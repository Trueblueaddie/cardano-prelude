  ...
  withTests 500 $
    property $
      do
        ...
        let maxTreeDepth = AnyDepth -- This should be okay since, in this property,
...
prop_ClosureTreeHasSpecifiedDepth = withTests 500 $
  property $ do
    let genElem :: Gen Word8
        genElem = Gen.word8 Range.constantBounded
    listLen <- forAll $ Gen.int (Range.constant 0 500)
    ...
    let travCycClos = NoTraverseCyclicClosures
